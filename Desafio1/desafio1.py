        ...
        try:
            ...
            if idProducto in datos:
                ...
                if 'nombre' in producto_data:
                    ...
                    print(f"\n\t\t| ID encontrado | \n| {producto_data['nombre']} | Marca: {producto_data['marca']} | Cantidad: {producto_data['cantidadStock']} unidades |\n")
                else:
                    producto = ProductosBebidas(**producto_data)
                    print(f"\n\t\t| ID encontrado | \n| {producto_data['tipoDeBebida']} | Marca: {producto_data['marca']} | Cantidad: {producto_data['cantidadStock']} unidades |\n")
            else:
